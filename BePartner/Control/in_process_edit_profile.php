...
if(isset($_POST["next1"])){
    ...
    if($error == 0){
        $password = $_POST["pwd"];
        $_SESSION["pwd"] = $obj->encryption($password);
        ...
        $result=$dbobj->updateData("reg_investor",$obj->decryption($_COOKIE["log"]),$_SESSION["pwd"],$_SESSION["firstName"],$_SESSION["lastName"],$_SESSION["DOB"],$_SESSION["gender"],$_SESSION["phone"],$_SESSION["pAddress"],$_SESSION["oname"],$_SESSION["linumber"],$_SESSION["tin"],$_SESSION["oaddress"],$_SESSION["edate"],$_SESSION["oemail"],$_SESSION["site"],$dbcon);
        // if($result){
        //     echo "Updated.<br>";
        //     $_SESSION["email"] = $email;
        //     if(isset($_COOKIE["autologin"])){
        //         setcookie("autologin",$obj->encryption($email),time()+2*24*60*60,"/","");
        //     }
        //     setcookie("log",$obj->encryption($email),time()+2*24*60*60,"/","");
        //      echo "<script> window.location.href='../view/in_profile.php'</script>";
        // }
        // echo $email;
        // echo $obj->encryption($email);
        //echo "No error";
