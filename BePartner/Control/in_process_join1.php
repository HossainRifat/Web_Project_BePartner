...
if(isset($_POST["next1"])){
    ...
    if($ext == "jpg" || $ext == "png"){
            ...
            if(move_uploaded_file($_FILES["myfile"]["tmp_name"],"../img/profile_".$email.".".$ext)){
       
                echo"file uploaded.SIze:".$_FILES["myfile"]["name"];
                $_SESSION["img"] ="../img/profile_".$email.".".$ext;
                echo $_SESSION["img"];
            }
            else{
                echo"Error Photo.<br>";
        ...
        echo "Only jpg and png file acceptable.";
        $error = 1;
    }
