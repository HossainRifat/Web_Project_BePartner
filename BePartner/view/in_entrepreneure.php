...
include "../Control/in_process_enterprenrur.php";
?>
...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <h4>Asking: <?php echo $row["asking_amount"] ?> BDT For <?php echo $row["share"] ?>% of the Company. </h4>
            <button name="deal" class="en_button">Confirm Deal</button>
            <input type="button" class="en_button" value="Give Offer" onclick="openofferForm()">
            ...
            <td><img src="<?php echo $row["photo"] ?>" alt="hello"       width="1040"
...
<div class="chat-popup" id="offer">
  <form action="" class="form-container" method="post">
    ...
    <input type="number" name="sharevalue" class="offfermsg">
